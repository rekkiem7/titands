...
<link href="{{ asset('/plugins_adicionales/sweetalert/dist/sweetalert.css')}}" rel="stylesheet"/>
...
<link href="{{ asset('template/plugins/datepicker/datepicker3.css')}}" rel="stylesheet" type="text/css" />
<link href="{{ asset('template/plugins/iCheck/all.css')}}" rel="stylesheet" type="text/css" />
<link href="{{ asset('template/plugins/colorpicker/bootstrap-colorpicker.min.css')}}" rel="stylesheet" type="text/css" />
