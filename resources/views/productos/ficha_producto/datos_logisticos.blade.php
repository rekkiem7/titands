...
<div class="input-group col-lg-5 col-md-5 col-sm-12">
	<input type="number" class="form-control"  id="anchoProducto" name="anchoProducto"/>
		<select class="form-control" id="unidadAnchoProducto" name="unidadAnchoProducto"onchange="">
...
<div class="input-group col-lg-5 col-md-5 col-sm-12">
	<input type="number" class="form-control" id="altoProducto" name="altoProducto"/>
		<select class="form-control"  id="unidadAltoProducto" name="unidadAltoProducto" onchange="">
		    @foreach($unidad_medida as $row_unid)
		    @if($row_unid->id==7 || $row_unid->id==8 ||$row_unid->id==9)
            <option value="{{$row_unid->id}}">{{$row_unid->abrev}}</option>
            @endif
...
<div class="input-group col-lg-5 col-md-5 col-sm-12">
	<input type="number" class="form-control" id="profundidadProducto" name="profundidadProducto"/>
		<select class="form-control"  id="unidadProfundidadProducto" name="unidadProfundidadProducto" onchange="">
		    @foreach($unidad_medida as $row_unid)
		    @if($row_unid->id==7 || $row_unid->id==8 ||$row_unid->id==9)
            <option value="{{$row_unid->id}}">{{$row_unid->abrev}}</option>
            @endif
...
<div class="input-group col-lg-5 col-md-5 col-sm-12">
	<input type="number" class="form-control" id="pesoProducto" name="pesoProducto"/>
		<select class="form-control" id="unidadPesoProducto" name="unidadPesoProducto" onchange="">
		    @foreach($unidad_medida as $row_unid)
